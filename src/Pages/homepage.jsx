                    ...
                    <div className="col-md-12">
                        <div className="card mx-auto border-primary" style={{ width: '20rem' }}>
                            ...
                            <div className="card-title">
                                ...
                                <p className="card-text fw-bold mx-1 mb-0 mt-2 pb-0">ABOUT ME</p>
                                <p className="card-text mx-1 mt-0 pt-0">
                                ...
                                <p className="card-text fw-bold mx-1 mb-0 mt-2">EXPERTISE</p>
                                <p className="card-text mx-1 mt-0">
                                ...
                                <p className="card-text fw-bold mx-1 mb-0 mt-2">LET'S KEEP IN TOUCH!
                                </p>

                                <a className="btn btn-outline-primary mx-1" href="mailto:bilalmuhammadyousuf543@gmail.com" target="_blank"><i className="fa fa-envelope mx-1"></i>Email</a>
                                <a className="btn btn-outline-primary mx-1" href="https://www.linkedin.com/in/bilal-muhammad-yousuf-20b533190/" target="_blank"><i className="fa fa-linkedin mx-1"></i>LinkedIn</a>
                                <a className="btn btn-outline-primary mx-1" href="https://github.com/Bilal-19" target="_blank"><i className="fa fa-github mx-1"></i>GitHub</a>
